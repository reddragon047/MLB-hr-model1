...
def build_board(date_str: str, n_sims: int, train_seasons: list[int], use_weather: bool):
    ...
    board["recent_power_bucket"] = _component_bucket(board.get("recent_damage_score", 0.0), high=62.0, mid=48.0)
    ...
    board["matchup_reason_primary"] = np.select(
        [
            ...
            pd.to_numeric(board.get("recent_damage_score", 0.0), errors="coerce").fillna(0.0) >= 62.0,
    ...
    cols = [
        ...
        "matchup_score_clean","matchup_label","matchup_reason_primary","p_hr_1plus_sim",
        "daily_matchup_hr_score","matchup_score_today",
        "pitcher_vulnerability_score","pitcher_risk_bucket",
        "pitch_mix_fit_score","pitch_match_bucket",
        "split_advantage_score","split_bucket",
        "opportunity_score","opportunity_bucket",
        "environment_score","environment_bucket",
        "recent_damage_score","recent_power_bucket",
        "pitcher_hr_score","bullpen_score",
        "dominant_pitch","dominant_pitch_usage","batter_vs_pitch_ratio",
        "park_factor","weather_mult","recent_form_mult","pitchtype_mult"
    ]
