...
def build_board(date_str: str, n_sims: int, train_seasons: list[int], use_weather: bool):
    ...
    preferred_cols = [
        ...
        "exp_pa", "matchup_mult", "pitchtype_mult", "recent_form_mult", "park_factor", "weather_mult",
        "dominant_pitch", "dominant_pitch_usage", "batter_vs_pitch_ratio", "recent_power_score",
