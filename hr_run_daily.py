...
import weather_overrides as _wx_overrides
...
def get_game_weather(lat: float, lon: float, date_str: str, game_hour_local: int | None = None) -> dict:
    return _wx_overrides.get_game_weather(lat, lon, date_str, game_hour_local=game_hour_local)


def compute_weather_multiplier(loc: dict | None, home_team: str, game_datetime: str | None, date_str: str) -> tuple[float, dict]:
    return _wx_overrides.compute_weather_multiplier(
        loc=loc,
        home_team=home_team,
        game_datetime=game_datetime,
        date_str=date_str,
        parse_game_hour_local=_parse_game_hour_local,
        default_out_to_cf_bearings=DEFAULT_OUT_TO_CF_BEARINGS,
        temp_multiplier_fn=temp_multiplier,
        wind_multiplier_fn=wind_multiplier,
    )
